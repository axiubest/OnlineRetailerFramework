...
//        self.backgroundColor = kColorTableBG;
        ...
        if (!_valueL) {
            ...
            _valueL.textColor = [UIColor orangeColor];
        }
        ...
        [_titleL mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(KWIDTH - 2*kPaddingLeftWidth);
        }];
...
//        cellHeight += [objStr getHeightWithFont:[UIFont systemFontOfSize:15] constrainedToSize:CGSizeMake(KWIDTH - 2*kPaddingLeftWidth, CGFLOAT_MAX)];
//        cellHeight += 12;
    }
    return cellHeight;
}
